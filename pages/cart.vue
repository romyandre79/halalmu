<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div
      v-if="cart.length === 0"
      class="text-center py-12 bg-white rounded-lg border border-gray-100 shadow-sm"
    >
      ...
      <NuxtLink
        to="/"
        class="bg-primary-600 text-white px-6 py-2 rounded-md font-bold hover:bg-primary-700 transition"
              ...
              <div class="mt-2 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                  <div class="flex items-center border rounded-md">
                    <button
                      type="button"
                      class="px-2 py-1 text-gray-600 hover:bg-gray-50 text-sm"
                    ...
                    <input
                      ...
                      :value="item.quantity"
                      readonly
                      class="w-10 text-center text-sm border-x py-1 focus:outline-none"
                    />
                    <button
                      type="button"
                      class="px-2 py-1 text-gray-600 hover:bg-gray-50 text-sm"
        ...
        <div class="mb-6">
          ...
          <div class="flex gap-2 mb-2">
            ...
            <input
              v-model="address"
              type="text"
              placeholder="Or enter address details..."
              class="flex-1 border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 text-sm px-3 py-2 border"
            />
          </div>
        ...
        <div v-if="address || coords">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
              ...
              :key="provider.id"
              :class="
                selectedDelivery?.id === provider.id
            ...
            >
              <div class="flex items-center gap-3">
                <div
                  class="w-10 h-10 rounded-full bg-white border flex items-center justify-center text-xl shadow-sm"
                >
                  {{ provider.icon }}
                </div>
                <div>
              ...
              <span class="font-bold text-primary-700"
                >Rp {{ provider.price.toLocaleString('id-ID') }}</span
              >
            </div>
          </div>
        </div>
      ...
      <div class="w-full lg:w-80">
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 sticky top-24">
          ...
          <div class="space-y-2 text-sm mb-4">
            ...
            <div class="flex justify-between text-gray-600">
              <span>Shipping</span>
              <span v-if="selectedDelivery" class="text-gray-900 font-medium"
                >Rp {{ selectedDelivery.price.toLocaleString('id-ID') }}</span
              >
          ...
          <button
            class="w-full bg-primary-600 text-white font-bold py-3 rounded-md hover:bg-primary-700 shadow-md transition"
          >
            Checkout
          </button>
        </div>
