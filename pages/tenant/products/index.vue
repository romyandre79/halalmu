<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      ...
      <NuxtLink
        to="/tenant/products/create"
        class="bg-primary-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-primary-700 flex items-center gap-2"
      >
        <svg
      ...
      <div class="p-4 border-b bg-gray-50 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          <input
            ...
            class="border rounded-md px-3 py-1.5 text-sm focus:ring-primary-500 focus:border-primary-500"
          />
          <select
            v-model="statusFilter"
            class="border rounded-md px-3 py-1.5 text-sm focus:ring-primary-500 focus:border-primary-500 bg-white"
          >
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="product in filteredProducts" :key="product.id">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                <div class="flex-shrink-0 h-10 w-10 bg-gray-100 rounded-md overflow-hidden">
                  <img
                    :src="`https://picsum.photos/seed/${product.name}/100/100`"
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
              <NuxtLink
                :to="`/tenant/products/edit/${product.id}`"
...
const products = ref([
  ...
  {
    id: 5,
    name: 'Wudu-Friendly Nail Polish',
    sku: 'H-P005',
    price: 95000,
    stock: 0,
    status: 'Sold Out',
