  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
      <div class="bg-primary-600 text-white p-6 rounded-lg shadow-md">
        ...
        <button
          class="bg-white text-primary-600 px-4 py-2 rounded font-bold text-sm hover:bg-primary-50"
          @click="openModal"
        >
          Withdraw Funds
        </button>
      ...
      <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
        ...
        <p class="text-xs text-gray-400">
          Funds from completed orders will be available after 24h.
        </p>
      </div>
    </div>
    ...
    >
      ...
      <div class="bg-white rounded-lg p-6 w-full max-w-md z-10 shadow-xl relative">
        ...
        <div class="flex justify-end gap-2">
          <button
            class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-md font-medium"
            @click="showWithdrawModal = false"
          >
            Cancel
          </button>
          <button
            class="px-4 py-2 bg-primary-600 text-white rounded-md font-medium hover:bg-primary-700"
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100">
      ...
      <div class="divide-y">
        ...
        <div
          ...
          :key="withdrawal.id"
          class="p-4 flex items-center justify-between bg-yellow-50"
        >
          <div>
        ...
        <div v-for="i in 5" :key="i" class="p-4 flex items-center justify-between">
          ...
          <div class="text-right">
            <div class="text-sm font-bold text-green-600">
              + Rp {{ (i * 150000).toLocaleString('id-ID') }}
            </div>
