<template>
  <div
    class="min-h-screen bg-gray-100 flex items-center justify-center p-4 print:bg-white print:p-0"
  >
    <div
      id="shipping-label"
      class="bg-white p-6 border-b-4 border-dashed border-gray-300 w-full max-w-md shadow-lg print:shadow-none print:w-full print:max-w-none print:border-none"
    >
      <div class="border-2 border-black p-4">
        ...
        <div class="mb-6 text-center">
          <!-- Mock Barcode -->
          <div
            class="h-16 bg-gray-800 w-3/4 mx-auto mb-2 flex items-center justify-center text-white text-xs tracking-widest overflow-hidden"
          >
            || ||| || ||||| || || |
          </div>
        ...
        <div class="border-t-2 border-black pt-4">
          ...
          <div class="mt-4 text-xs text-gray-500">Notes: Please handle with care. Fragile.</div>
        </div>
      </div>

      <div class="mt-6 flex gap-4 print:hidden">
        <button
          class="flex-1 bg-primary-600 text-white py-2 rounded-md font-bold hover:bg-primary-700"
          @click="print"
        >
          Print Now
        </button>
        <button
          class="flex-1 bg-gray-200 text-gray-800 py-2 rounded-md font-bold hover:bg-gray-300"
          @click="close"
        >
          Close
        </button>
