  ...
  <div>
    ...
    <div class="space-y-4">
      ...
      >
        <!-- Header -->
        <div
          class="bg-gray-50 px-6 py-4 flex items-center justify-between border-b border-gray-100"
        >
        ...
        <div class="p-6">
          <div class="flex items-start gap-4">
            <div class="h-16 w-16 bg-gray-100 rounded-md overflow-hidden flex-shrink-0">
              <img
                :src="`https://picsum.photos/seed/${order.productName}/100/100`"
          ...
          <div class="mt-6 flex items-center justify-end gap-3 pt-4 border-t border-gray-50">
            <div class="mr-auto text-sm">
              ...
              <span class="font-bold text-primary-600 text-lg ml-2"
            ...
            <button
              ...
              @click="requestPickup(order)"
            >
              Request Pickup
            </button>

            <span v-if="order.status === 'Waiting Payment'" class="text-sm text-gray-500 italic"
              >Waiting for customer payment...</span
            >

            <button
              v-if="order.status === 'Shipped'"
              class="px-4 py-2 border border-blue-200 text-blue-600 bg-blue-50 rounded-md text-sm font-medium cursor-default"
            >
              Track Shipment
            </button>
          </div>
...
const orders = ref([
  {
    id: 1,
    invoice: 'INV/20260201/001',
    date: '1 Feb 2026, 14:30',
    status: 'To Ship',
  ...
  {
    id: 3,
    invoice: 'INV/20260201/003',
    date: '1 Feb 2026, 09:00',
    status: 'Shipped',
    productName: 'Modest Tunic Dress',
    variant: 'Size M, Blue',
    price: 250000,
    total: 260000,
  },
  {
    id: 4,
    invoice: 'INV/20260201/004',
    date: '31 Jan 2026, 18:45',
    status: 'To Ship',
    productName: 'Halal Cosmetics Set',
    variant: 'Full Kit',
    price: 350000,
    total: 360000,
  },
  {
    id: 5,
    invoice: 'INV/20260130/099',
    date: '30 Jan 2026, 10:20',
    status: 'Shipped',
    productName: 'Instant Noodles Case',
