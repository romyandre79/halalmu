      ...
      <div class="w-64 hidden lg:block flex-shrink-0">
        <div class="bg-white border border-gray-100 rounded-lg p-4 shadow-sm">
          ...
          <div class="mb-6">
            ...
            <button
              class="w-full bg-primary-50 text-primary-600 px-3 py-1 rounded text-sm font-medium hover:bg-primary-100"
            >
              Apply
            </button>
          </div>
      ...
      <div class="flex-1">
        ...
        <div v-else class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <div
            v-for="i in 12"
            :key="i"
            class="bg-white rounded-lg border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition duration-200 cursor-pointer flex flex-col h-full group"
          >
            <!-- Image -->
            <div class="aspect-square bg-gray-100 relative overflow-hidden rounded-t-lg">
              <img
                :src="`https://picsum.photos/seed/${categoryName}${i}/300/300`"
            ...
            <div class="p-3 flex flex-col flex-1">
              <h3 class="text-sm text-gray-700 line-clamp-2 mb-2 leading-snug">
                Premium {{ categoryName }} Item #{{ i }} - High Quality
              </h3>
              <div class="mt-auto">
                <div class="text-primary-600 font-bold text-base mb-1">
                  Rp {{ (i * 25000).toLocaleString('id-ID') }}
                </div>
                ...
                <button
                  ...
                  @click.stop="
                    addToCart({
                      id: i,
                      name: `Premium ${categoryName} Item #${i}`,
                      price: i * 25000,
                    })
                  "
                >
...
useSeoMeta({
  ...
  description: () =>
    `Shop the best ${categoryName.value} products on Halalmu. Certified halal, verified sellers, and great prices.`,
